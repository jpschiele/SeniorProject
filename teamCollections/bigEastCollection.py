...
collection = db.collection('BigEast')  # opens 'BigEast' collection

final_df = pd.DataFrame()

# list of BigEast schools
schools = ['butler', 'connecticut', 'creighton', 'depaul', 'georgetown',
...
for year in years:
    ...
    for school in schools:
        ...
        # automatic break occurs after each year to refresh call timer
